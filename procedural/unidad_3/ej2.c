...
int main()
{
    ...
    printf("Se ha recaudado un total de: $%.2f", salesProcessor(products));
...
void showProductsNoStock(int num)
{
    printf("Cantidad de productos sin stock: %d", num);
    return;
};

void showActualStockCosts(float amount)
{
    printf("Costo actual del stock acumulado: $%.2f", amount);
    return;
};
